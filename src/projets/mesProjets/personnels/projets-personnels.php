				...
				<div class="skill-group-vertical">
					<div class="container">
						...
						<section class="content--durga">
							<div class="grid">
								<!--<a href="/portFolio_GUYOT/Projets/Perso/PortFolio">--><a href="#"><div class="grid__item">
									<div class="folder folder--durga folder--a">
										<div class="folder__icon folder__icon--perspective">
											...
											<div class="folder__preview folder__preview--text">
												<p class="folder__detail">Site</p>
												<p class="folder__detail">que vous</p>
												<p class="folder__detail">visualisez</p>
												<p class="folder__detail">actuellement</p>
										...
										<h3 class="folder__caption">Portfolio</h3>
									</div>
								</div></a>
