            ...
            <div class="skill-group-vertical">
                <div class="container">
                    <div class="col-md-12 titre-portfolio">
                        <h1><span>Mes projets scolaires</span></h1>
                    </div>
                    <div class="col-md-12 interet-portfolio">
                        <section class="content--durga">
                            <div class="grid">
                                <a href="/portFolio_GUYOT/Projets/Scolaires/Java/entrepriseGSB"><div class="grid__item">
                                        <div class="folder folder--durga folder--a">
                                            <div class="folder__icon folder__icon--perspective">
                                                ...
                                                <div class="folder__preview folder__preview--text">
                                                    ...
                                                    <p class="folder__detail">Affiche les</p>
                                                    <p class="folder__detail">Visiteurs</p>
                                                    <p class="folder__detail">de GSB</p>
                                            ...
                                            <h3 class="folder__caption">Java GSB</h3>
                                        </div>
                                    </div></a>
                                <div class="grid__item"><div class="dummy"><svg><use xlink:href="#icon-folderdummy"></use></svg></div></div>
                                <!--<a href="/portFolio_GUYOT/Projets/Scolaires/MVC">-->
                                <a href="/portFolio_GUYOT/Projets/Scolaires/MVC/entrepriseGSB"><div class="grid__item">
                                        <div class="folder folder--durga folder--b">
                                            <div class="folder__icon folder__icon--perspective">
                                                ...
                                                <div class="folder__preview folder__preview--text">
                                                    <p class="folder__detail">Application web</p>
                                                    <p class="folder__detail">Remboursement des frais</p>
                                                    <p class="folder__detail">des Visiteurs</p>
                                                    <p class="folder__detail">de GSB</p>
                                                    <p class="folder__detail">...</p>
                                                </div>
                                                <div class="folder__icon-img folder__icon-img--cover">
                                            ...
                                            <h3 class="folder__caption">GSB</h3>
                                        </div>
                                    </div></a>
                                <div class="grid__item"><div class="dummy"><svg><use xlink:href="#icon-folderdummy"></use></svg></div></div>
                                <a href="/portFolio_GUYOT/Projets/Scolaires/EquipVis/entrepriseGSB"><div class="grid__item">
                                        <div class="folder folder--durga folder--c">
                                            <div class="folder__icon folder__icon--perspective">
                                                ...
                                                <div class="folder__icon-deco"></div>
                                                <div class="folder__preview folder__preview--text">
                                                    <p class="folder__detail">Explication du</p>
                                                    <p class="folder__detail"> contexte</p>
                                                    <p class="folder__detail"> GSB</p>
                                                    <p class="folder__detail">...</p>
                                                </div>
                                                <div class="folder__icon-img folder__icon-img--cover">
                                                    <svg class="folder__icon-svg"><use xlink:href="#icon-foldercover"></use></svg>
                                            ...
                                            <h3 class="folder__caption">Equiper les visiteurs</h3>
                                        </div>
                                    </div></a>
                                <div class="grid__item"><div class="dummy"><svg><use xlink:href="#icon-folderdummy"></use></svg></div></div>
                               <a href="/portFolio_GUYOT/Projets/Scolaires/Zend/entrepriseGSB"><div class="grid__item">
                                        <div class="folder folder--durga folder--d">
                                            <div class="folder__icon folder__icon--perspective">
                                                <div class="folder__icon-img folder__icon-img--back">
                                                    <svg class="folder__icon-svg"><use xlink:href="#icon-folderback"></use></svg>
                                                </div>
                                                <div class="folder__icon-deco"></div>
                                                <div class="folder__preview folder__preview--text">
                                                    <p class="folder__detail">Utilisation du</p>
                                                    <p class="folder__detail">framework</p>
                                                    <p class="folder__detail">Zend dans</p>
                                                    <p class="folder__detail">le contexte GSB</p>
                                                    <p class="folder__detail">...</p>
                                                </div>
                                                <div class="folder__icon-img folder__icon-img--cover">
                                                    <svg class="folder__icon-svg"><use xlink:href="#icon-foldercover"></use></svg>
                                            ...
                                            <h3 class="folder__caption">Zend</h3>
                                        </div>
                                    </div></a>
                                <div class="grid__item"><div class="dummy"><svg><use xlink:href="#icon-folderdummy"></use></svg></div></div>
<a href="/portFolio_GUYOT/Projets/Scolaires/Android/entrepriseGSB"><div class="grid__item">
                                        <div class="folder folder--durga folder--e">
                                            <div class="folder__icon folder__icon--perspective">
                                                <div class="folder__icon-img folder__icon-img--back">
                                                    <svg class="folder__icon-svg"><use xlink:href="#icon-folderback"></use></svg>
                                                </div>
                                                ...
                                                <div class="folder__preview folder__preview--text">
                                                    ...
                                                    <p class="folder__detail">sur smartphone</p>
                                                    <p class="folder__detail">dans</p>
                                                    <p class="folder__detail">le contexte GSB</p>
                                                    <p class="folder__detail">...</p>
                                                </div>
                                                <div class="folder__icon-img folder__icon-img--cover">
                                            ...
                                            <h3 class="folder__caption">Android</h3>
                                        </div>
                                    </div></a>
