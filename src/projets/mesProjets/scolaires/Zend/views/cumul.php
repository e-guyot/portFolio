                ...
                <div class="skill-group-vertical">
                    <div class="container ">
                        <div class="col-md-12 titre-portfolio">
                            <h1><span>Zend - cumul Frais forfait</span></h1>
                        </div>
                        <div class="col-md-12 text-portfolio">

                            <p>L'onglet Cumul/Visiteur/FraisForfait permet de visualiser par mois et par visiteur la totalité des frais forfait établi pour ce visiteur. <br><img src="/portFolio_GUYOT/src/projets/mesProjets/scolaires/Zend/img/Capture3.PNG"> </p>                          
                        </div>
                    </div>
                </div>
<?= $nav->getNav(4, 'Zend'); ?>
