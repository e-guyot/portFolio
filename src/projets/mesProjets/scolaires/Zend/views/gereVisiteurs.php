                ...
                <div class="skill-group-vertical">
                    <div class="container ">
                        <div class="col-md-12 titre-portfolio">
                            <h1><span>Zend - Gérer les visiteurs</span></h1>
                        </div>
                        <div class="col-md-12 text-portfolio">

                            <p>Le menu gérer les visiteurs permet d'obtenir toutes les informations des visiteurs présent dans la base de données. Le tableau est en plusieurs partie dont certaines cases cliquables, par exemple : <br>
                                - <span>Langues parlées</span> : affiche un tableau sur une autre page avec le niveau ainsi que le type de langue. <br>
                                - <span>NbFichesFrais</span> : affiche le total des fches de frais crées. Sur une autre page affiche le détail des fiches de frais.<br><img src="/portFolio_GUYOT/src/projets/mesProjets/scolaires/Zend/img/Capture1.PNG"> </p>                          
                        </div>
                    </div>
                </div>
<?= $nav->getNav(2, 'Zend'); ?>
