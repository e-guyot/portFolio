                ...
                <div class="skill-group-vertical">
                    <div class="container ">
                        <div class="col-md-12 titre-portfolio">
                            <h1><span>Zend - Voir toutes les fiches de frais</span></h1>
                        </div>
                        <div class="col-md-12 text-portfolio">

                            <p>Le menu Voir-Exporter Les Fiches de frais affcihe  <br><img src="/portFolio_GUYOT/src/projets/mesProjets/scolaires/Zend/img/Capture2.PNG"> </p>                          
                        </div>
                    </div>
                </div>
<?= $nav->getNav(3, 'Zend'); ?>
