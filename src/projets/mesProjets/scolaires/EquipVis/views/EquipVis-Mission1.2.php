                ...
                <div class="skill-group-vertical">
                    <div class="container ">
                        <div class="col-md-12 titre-portfolio">
                            <h1><span>Equiper les Visiteurs - Mission 1.2</span></h1>
                        </div>
                        <div class="col-md-12 text-portfolio">

                            <p>Architecture Web N Tiers, estimation des coûts : <br>
                                <img src="/portFolio_GUYOT/src/projets/mesProjets/scolaires/EquipVis/img/estimation-cloud.PNG">
                            </p>                           
                        </div>
