<html lang="fr">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/portFolio_GUYOT/src/accueil/css/style-titre.css">
				...
				<div class="skill-group-vertical">
					<div class="container">
						...
						<div class="col-md-12 text-portfolio">
							<div class="row">
                                <p>Le laboratoire Galaxy Swiss Bourdin (GSB) engage des visiteurs qui sont amenés à se déplacer. Leurs déplacements et actions de terrain engendrent des frais qui doivent être pris en charge par la comptabilité : ils disposent d’une application pour saisir leurs frais. L’application doit maintenant proposer un menu comptable afin de suivre les frais enregistrés par les visiteurs.
                                	(La première étape afin que les comptables accèdent à l'application remboursement des frais est l'authentification. Les utilisateurs ont plusieurs rôle et selon leur rôle il accède à un accueil différent.)
                                	<img src="/portFolio_GUYOT/src/projets/mesProjets/scolaires/GSB/img/schema.JPG"></p>
							</div>
					</div>	
				</div>
			</div>
