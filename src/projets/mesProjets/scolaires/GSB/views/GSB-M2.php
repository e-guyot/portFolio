<html lang="fr">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/portFolio_GUYOT/src/accueil/css/style-titre.css?id=2"><link rel="stylesheet" type="text/css" href="/portFolio_GUYOT/src/menuTriangle/css/css.css">
				...
				<div class="skill-group-vertical">
					<div class="container">
						...
						<div class="col-md-12 text-portfolio">
							<div class="row">
                                <p>La partie Suivre le paiement des fiches de frais permet au comptable de valider le remboursement des fiches de frais. L'affichage rappelle tous les frais qui ont été validé. Si le comptable souhaite valider le remboursement il clique sur le button, la fiche dans la base de donnée change alors d'état. <br><img src="/portFolio_GUYOT/src/projets/mesProjets/scolaires/GSB/img/rembFiche.JPG"></p>
							</div>
					</div>	
				</div>
			</div>
