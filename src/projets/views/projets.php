<html lang="fr">
	...
	<body>
				...
				<div class="skill-group-vertical">
					<div class="container">
						...
						<section class="content--durga">
							<div class="grid">
								<a href="/portFolio_GUYOT/Projets/Stages">
									...
									<div class="folder folder--durga folder--a">
										<div class="folder__icon folder__icon--perspective">
											...
											<div class="folder__preview folder__preview--text">
												<p class="folder__detail">Voir mes </p>
												<p class="folder__detail">différents</p>
												<p class="folder__detail">stages </p>
												<p class="folder__detail">effectués</p>
												<p class="folder__detail">en Entreprise</p>
										...
										<h3 class="folder__caption">Mes stages</h3>
									</div>
									
								</div></a>
								<div class="grid__item"><div class="dummy"><svg><use xlink:href="#icon-folderdummy"></use></svg></div></div>
								<a href="/portFolio_GUYOT/Projets/Scolaires"><div class="grid__item">
									<div class="folder folder--durga folder--b">
										<div class="folder__icon folder__icon--perspective">
											...
											<div class="folder__preview folder__preview--text">
												...
												<p class="folder__detail">réalisés au</p>
												<p class="folder__detail">centre de formation</p>
												<p class="folder__detail">...</p>
											</div>
											<div class="folder__icon-img folder__icon-img--cover">
												<svg class="folder__icon-svg"><use xlink:href="#icon-foldercover"></use></svg>
										...
										<h3 class="folder__caption">Projets scolaires</h3>
									</div>
								</div></a>
								<div class="grid__item"><div class="dummy"><svg><use xlink:href="#icon-folderdummy"></use></svg></div></div>
								<a href="/portFolio_GUYOT/Projets/TabSynth" target="_blank"><div class="grid__item">
									<div class="folder folder--durga folder--c">
										<div class="folder__icon folder__icon--perspective">
											...
											<div class="folder__icon-deco"></div>
											<div class="folder__preview folder__preview--text">
												<p class="folder__detail">Voir mon </p>
												<p class="folder__detail">tableau</p>
												<p class="folder__detail">récapitulatif</p>
												<p class="folder__detail">du BTS SIO</p>
												<p class="folder__detail">...</p>
											</div>
											<div class="folder__icon-img folder__icon-img--cover">
												<svg class="folder__icon-svg"><use xlink:href="#icon-foldercover"></use></svg>
										...
										<h3 class="folder__caption">Tableau de synthèse</h3>
									</div>
								</div></a>
								<div class="grid__item"><div class="dummy"><svg><use xlink:href="#icon-folderdummy"></use></svg></div></div>
								<a href="/portFolio_GUYOT/Projets/Personnels"><div class="grid__item">
									<div class="folder folder--durga folder--d">
										<div class="folder__icon folder__icon--perspective">
											...
											<div class="folder__preview folder__preview--text">
												<p class="folder__detail">Voir mes</p>
												<p class="folder__detail">projets </p>
												<p class="folder__detail">réalisés</p>
												<p class="folder__detail">personnellement</p>
												<p class="folder__detail">...</p>
											</div>
											<div class="folder__icon-img folder__icon-img--cover">
												<svg class="folder__icon-svg"><use xlink:href="#icon-foldercover"></use></svg>
										...
										<h3 class="folder__caption">Projets personnels</h3>
									</div>
								</div></a>
								<div class="grid__item"><div class="dummy"><svg><use xlink:href="#icon-folderdummy"></use></svg></div></div>
								<a href="/portFolio_GUYOT/Projets/Veille"><div class="grid__item">
									<div class="folder folder--durga folder--e">
										<div class="folder__icon folder__icon--perspective">
											...
											<div class="folder__icon-deco"></div>
											<div class="folder__preview folder__preview--text">
												<p class="folder__detail">Actualité</p>
												<p class="folder__detail">Technologique</p>
												<p class="folder__detail">...</p>
											</div>
											<div class="folder__icon-img folder__icon-img--cover">
												<svg class="folder__icon-svg"><use xlink:href="#icon-foldercover"></use></svg>
										...
										<h3 class="folder__caption">Veille Technologique</h3>
									</div>
								</div></a>
								<div class="grid__item"><div class="dummy"><svg><use xlink:href="#icon-folderdummy"></use></svg></div></div>
		...
		(function() {
			...
			new DurgaFx(document.querySelector('.content--durga .folder--f'));
		})();
		</script>
